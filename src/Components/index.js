...
export const data = {
    ...
    email: 'okwuchiadanma@gmail.com',
    phone: '+234 813 000 0000',
    decription: ' I am a developer with a passion for learning new technologies and building user friendly applications',
    resume: 'https://drive.google.com/file/d/1puL5Sr3B9D1ST7XiOk4p-7WZCONwKISs/view?usp=sharing',
    socialLinks: {
        github: 'https://github.com/okwuchiada"><i class="fab fa-github',
        linkedin: 'https://www.linkedin.com/in/adanma-okwuchi-29162b197/',
        twitter: 'https://twitter.com/_adahh_',
        instagram: '',
    },
    about: `I am a frontend developer. I am passionate about building scalable and performant web applications.`,
    experience: [
        {
            title: 'Frontend Developer',
            company: 'Lanor, United States',
            year: '2022 - Present',
            desc: ``,
        },
        {
            title: 'Frontend Developer',
            company: 'Afrits Innovation, Nigeria',
            year: '2021 - 2022',
