    ...
    <Main>
      <div className="hero-page">
        ...
        <div className="intro">
          ...
          <p>
            Software Development Techster at Tech4Dev Women Techster Fellowship
          </p>
          ...
          <Button className="email-btn">
            <a
              href="https://drive.google.com/file/d/1egjpt-uOVV1Lip3pauNp9ynPVhzx1Enh/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              View Resume
